...
import { Container, WallPaper } from './tuningStyle'
import { tuningdata } from './mock/tunig666';
import { useParams } from 'react-router-dom';



const TuningDateilComponent = () => {
    let {id} = useParams();
   //console.log(tuningdata);

   const dataById = tuningdata.find((data)=> data.id === parseInt(id) );
...
export default TuningDateilComponent