...
import { BtnCont, ChildWrap, Chiziq, Chiziq2,  Container, DataCont, DivLeft, DivRight, MidBarCont, MidBarContLeft, MidBarContRight, WallPaper } from './tuningStyle'
    ...
    <WallPaper>
     ...
     <MidBarContRight style={{display:"flex",flexDirection:"column"}}>
      ...
      {data.map((value,index)=>{
          return(
            <Link to={`/tunig-detail/${value.id}`}>
            <ChildWrap key={index}>
            <img src={value.car.photo} alt="imgcar" style={{width:"202.42px",borderRadius:"15px",height:"145px",display:"flex",alignItems:"center",justifyContent:"center"}}/>
