...
import { Container, WallPaper } from './caravaStyle'
import { caravandata } from './mock/caravan777';
...
const CaravandetailComponent = () => {
  let {id} = useParams();
  //onsole.log(caravandata);

  const dataById2 = caravandata.find((data)=> data.id === parseInt(id) );
    
  return (
    <Container>
        <WallPaper>
              <Button variant="outlined" sx={{color:"white",borderRadius: "10px",height: "76.407px",width: "509.208px",fontFamily: "Montserrat",textAlign:"center",fontSize:"60PX",fontWeight:"700PX",border:"none"}}>{dataById2.car.company}</Button><br />
    ...
    <div>
     <div style={{display:"flex",height: "380px",gap:"20px"}}>
      <div style={{flex:"1"}}>
        <img src={dataById2.car.photo} alt=""  style={{height:"460px",padding:"15px",borderRadius:"20px",width:"100%"}}/>
      </div>
      <div style={{flex:"1"}}>
       ...
       <div style={{display:"flex",flexDirection:"column",flex:"1"}}>
        <p>{dataById2.car.company}</p>
        <p style={{marginTop:"10px"}}>{dataById2.car.date}</p>
       </div>
       <div style={{flex:"1",marginLeft:"350px"}}>
        <p style={{color:"#006DAB"}}>{dataById2.car.cost}</p>
       ...
       <div style={{display:"flex",marginTop:"15px"}}>
        ...
        <div style={{flex:"1",marginLeft:"350px"}}>
        <p style={{marginTop:"10px"}}>{dataById2.car.company}</p>
        <p style={{marginTop:"10px"}}>{dataById2.car.people}</p>
        <p style={{marginTop:"10px"}}>{dataById2.car.type}</p>
        </div>
       </div>
        </div>
     ...
     <div style={{display:"flex"}}>
      <div style={{flex:"1"}}>
      <img src={imgcar2} alt="imgcar2" style={{display:"flex",alignItems:"center",justifyContent:"center"}} />
      </div>
      <div style={{flex:"1"}}>
